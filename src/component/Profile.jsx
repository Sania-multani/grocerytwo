...
//       {/* <span className="profile-badge">New Client</span> */}
//       <button className="appointment-btn mt-3"  onClick={()=>setAccount(!account)}>My Profile</button>
//        <button className="appointment-btn mt-1" onClick={()=>setPassword(!password)}>Change Password</button>
//         <button className="appointment-btn mt-1">Order List</button>
